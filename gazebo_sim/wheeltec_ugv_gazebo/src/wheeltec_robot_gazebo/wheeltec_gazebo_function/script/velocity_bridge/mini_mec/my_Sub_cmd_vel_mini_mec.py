...
def set_mini_mec_velocity(data):
    pub_vel_mini_mec_left_front_wheel = rospy.Publisher('mini_mec_left_front_wheel_velocity_controller/command', Float64, queue_size=1)
    pub_vel_mini_mec_right_front_wheel = rospy.Publisher('mini_mec_right_front_wheel_velocity_controller/command', Float64, queue_size=1)
    pub_vel_mini_mec_left_rear_wheel = rospy.Publisher('mini_mec_left_rear_wheel_velocity_controller/command', Float64, queue_size=1)
    pub_vel_mini_mec_right_rear_wheel = rospy.Publisher('mini_mec_right_rear_wheel_velocity_controller/command', Float64, queue_size=1)
...
def Sub_cmd_vel_mini_mec():
    ...
    rospy.init_node('Sub_cmd_vel_mini_mec')
